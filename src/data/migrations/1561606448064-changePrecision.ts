...
export class changePrecision1561606448064 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query('ALTER TABLE `expense` CHANGE `cost` `cost` decimal(15,2) NOT NULL DEFAULT 0');
        await queryRunner.query('ALTER TABLE `budget` CHANGE `name` `name` varchar(255) NULL DEFAULT null');
        await queryRunner.query('ALTER TABLE `budget` CHANGE `total` `total` decimal(15,2) NOT NULL DEFAULT 0');
    }
